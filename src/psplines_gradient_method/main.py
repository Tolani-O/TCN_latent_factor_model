...
def main(K, R, L, intensity_mltply, intensity_bias, tau_psi, tau_beta, tau_s, num_epochs):
    ...
    folder_name = f'main_L{L}_K{K}_R{R}_int.mltply{intensity_mltply}_int.add{intensity_bias}_tauBeta{tau_beta}_tauS{tau_s}_iters{num_epochs}'
