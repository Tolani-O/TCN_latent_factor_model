...
def main_function():
    ...
    dgamma, dd2, dalpha, dzeta, dchi, dc = model.compute_analytical_grad_time_warping(tau_psi, tau_beta, tau_s)
    dgamma_num, dd2_num, dalpha_num, dzeta_num, dchi_num, dc_num = model.compute_numerical_grad_time_warping_parallel(tau_psi, tau_beta, tau_s)
    ...
    print(f"Max Errors: dgamma {dgamma_error}, dd2 {dd2_error}, dchi {dchi_error}, dc {dc_error}")
