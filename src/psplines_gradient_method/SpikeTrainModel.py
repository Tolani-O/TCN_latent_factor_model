...
class SpikeTrainModel:
    ...
    def log_obj_with_backtracking_line_search_and_time_warping(self, tau_psi, tau_beta, tau_G,
                                                               alpha_factor=1e-2, beta_factor=1e-2,
    ...
    def compute_analytical_grad_time_warping(self, tau_psi, tau_beta):
        ...
        return dlogL_dalpha, dlogL_dbeta, dlogL_dG_star, dlogL_dd
    ...
    def compute_numerical_grad_time_warping_parallel(self, tau_psi, tau_beta, tau_G):
        ...
        # beta gradient
        beta_async_results = [pool.apply_async(self.compute_grad_chunk, args=(self.beta, l, eps, tau_psi, tau_beta, tau_G, loss)) for l in range(L)]
        ...
        beta_grad = np.vstack([r.get() for r in beta_async_results])
